...
public class UserController {
    ...
    public ResponseEntity<List<UserDTO>> list(@RequestParam(required = false) RoleName role,
                                               @RequestParam(required = false) AccountStatus accountStatus) {
        return ResponseEntity.ok(userService.listUsers(role, accountStatus));
    }

    @GetMapping("/citizens")
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<List<UserDTO>> listCitizens() {
        return ResponseEntity.ok(userService.listCitizens());
    }

    @GetMapping("/staff")
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<List<UserDTO>> listStaff() {
    ...
    @GetMapping("/pending")
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<List<UserDTO>> listPending() {
    ...
    public ResponseEntity<UserDTO> getUser(@PathVariable Long id, @AuthenticationPrincipal CurrentUser currentUser) {
